...
export type Query = {
  ...
  flash?: Maybe<Flash>;
  flashes: Array<Flash>;
  panaromaswapDayData?: Maybe<PanaromaswapDayData>;
  panaromaswapDayDatas: Array<PanaromaswapDayData>;
...
export type QueryPanaromaswapDayDataArgs = {
  id: Scalars['ID'];
  block?: Maybe<Block_Height>;
  subgraphError?: _SubgraphErrorPolicy_;
};
...
export type QueryPanaromaswapDayDatasArgs = {
  skip?: Maybe<Scalars['Int']>;
  first?: Maybe<Scalars['Int']>;
  orderBy?: Maybe<PanaromaswapDayData_OrderBy>;
  orderDirection?: Maybe<OrderDirection>;
  where?: Maybe<PanaromaswapDayData_Filter>;
  block?: Maybe<Block_Height>;
  subgraphError?: _SubgraphErrorPolicy_;
};
...
export type SubscriptionPanaromaswapDayDataArgs = {
  id: Scalars['ID'];
  block?: Maybe<Block_Height>;
  subgraphError?: _SubgraphErrorPolicy_;
};
...
export type SubscriptionPanaromaswapDayDatasArgs = {
  skip?: Maybe<Scalars['Int']>;
  first?: Maybe<Scalars['Int']>;
  orderBy?: Maybe<PanaromaswapDayData_OrderBy>;
  orderDirection?: Maybe<OrderDirection>;
...
export type PanaromaswapDayData = {
  __typename?: 'PanaromaswapDayData';
  id: Scalars['ID'];
  date: Scalars['Int'];
...
export type PanaromaswapDayData_Filter = {
  id?: Maybe<Scalars['ID']>;
  id_not?: Maybe<Scalars['ID']>;
  id_gt?: Maybe<Scalars['ID']>;
  id_lt?: Maybe<Scalars['ID']>;
  ...
  /** Filter for the block changed event. */
  _change_block?: Maybe<BlockChangedFilter>;
  and?: Maybe<Array<Maybe<PanaromaswapDayData_Filter>>>;
  or?: Maybe<Array<Maybe<PanaromaswapDayData_Filter>>>;
};

export enum PanaromaswapDayData_OrderBy {
  Id = 'id',
  Date = 'date',
  VolumeEth = 'volumeETH',
  VolumeUsd = 'volumeUSD',
...
export type AllV2edgeTicksQueryVariables = Exact<{
  poolAddress: Scalars['String'];
  skip: Scalars['Int'];
}>;


export type AllV2edgeTicksQuery = (
  { __typename?: 'Query' }
  & { ticks: Array<(
    { __typename?: 'Tick' }
...
export const AllV2edgeTicksDocument = `
    query allV2edgeTicks($poolAddress: String!, $skip: Int!) {
  ticks(
    first: 1000
    skip: $skip
...
const injectedRtkApi = api.injectEndpoints({
  endpoints: (build) => ({
    allV2edgeTicks: build.query<AllV2edgeTicksQuery, AllV2edgeTicksQueryVariables>({
      query: (variables) => ({ document: AllV2edgeTicksDocument, variables })
    }),
...
export const { useAllV2edgeTicksQuery, useLazyAllV2edgeTicksQuery, useFeeTierDistributionQuery, useLazyFeeTierDistributionQuery } = injectedRtkApi;
