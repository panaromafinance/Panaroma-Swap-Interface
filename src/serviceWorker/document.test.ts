...
describe('document', () => {
  describe('matchDocument', () => {
    const TEST_DOCUMENTS = [
      ...
      [{ request: {}, url: { hostname: 'app.panaromaswap.org', pathname: '' } }, false],
      [{ request: { mode: 'navigate' }, url: { hostname: 'app.panaromaswap.org', pathname: '' } }, true],
      [{ request: { mode: 'navigate' }, url: { hostname: 'app.panaromaswap.org', pathname: '/#/swap' } }, true],
      [{ request: { mode: 'navigate' }, url: { hostname: 'app.panaromaswap.org', pathname: '/asset.gif' } }, false],
