...
export function computePanaromaCirculation(
  PANA: Token,
  blockTimestamp: BigNumber,
  unclaimedPanaroma: CurrencyAmount<Token> | undefined
  ...
  return unclaimedPanaroma ? total.subtract(unclaimedPanaroma) : total
}
