...
describe('utils', () => {
  describe('#isAddress', () => {
    ...
    it('returns the checksummed address', () => {
      expect(isAddress('0xf164fc0ec4e93095b804a4795bbe1e041497b92a')).toBe('0x7E197ef9539CFBcA831729D1571df6b18A12e1Ed')
      expect(isAddress('0x7E197ef9539CFBcA831729D1571df6b18A12e1Ed')).toBe('0x7E197ef9539CFBcA831729D1571df6b18A12e1Ed')
    })

    it('succeeds even without prefix', () => {
      expect(isAddress('f164fc0ec4e93095b804a4795bbe1e041497b92a')).toBe('0x7E197ef9539CFBcA831729D1571df6b18A12e1Ed')
    })
