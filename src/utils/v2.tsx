...
export default function Pool() {
  ...
  const unsupportedV2Network =
    chainId && UNSUPPORTED_V2POOL_CHAIN_IDS.includes(chainId);
            ...
            <CardSection>
              <AutoColumn gap="md">
                ...
                <ExternalLink
                  ...
                  target="_blank"
                  href="https://docs.panaromaswap.org/protocol/V2/concepts/core-concepts/pools">
                  <ThemedText.DeprecatedWhite fontSize={14}>
              ...
              <AutoColumn gap="md" style={{ width: "100%" }}>
                <Layer2Prompt>
                  <ThemedText.DeprecatedBody
                    ...
                    textAlign="center">
                    <Trans>
                      V2 Pool is not available on Layer 2. Switch to Layer 1
                      Ethereum.
                    </Trans>
                  </ThemedText.DeprecatedBody>
                </Layer2Prompt>
