 ...
 */
export function swapErrorToUserReadableMessage(error: any): React.ReactElement {
 ...
 // console.log("321321 reason", reason);


  switch (reason) {
    case "PanaromaswapV1Router: EXPIRED":
      return (
        <Trans>
    ...
    case "PanaromaswapV1Router: INSUFFICIENT_OUTPUT_AMOUNT":
    case "PanaromaswapV1Router: EXCESSIVE_INPUT_AMOUNT":
      return (
        <Trans>
    ...
    case "PanaromaswapV1: TRANSFER_FAILED":
      return (
        <Trans>
    ...
    case "PanaromaswapV1: K":
      return (
        <Trans>
          The Panaromaswap invariant x*y=k was not satisfied by the swap. This
    ...
    case "STF":
      return (
        <Trans>
          ...
          tokens are incompatible with Panaromaswap V2edge.
        </Trans>
      );
    case "TF":
      return (
      ...
      if (reason?.indexOf("undefined is not an object") !== -1) {
        ...
        return (
          <Trans>
            ...
            transfer and rebase tokens are incompatible with Panaromaswap V2edge.
          </Trans>
        );
      }
      return (
        <Trans>
          ...
          incompatible with Panaromaswap V2edge.
        </Trans>
      );
  }
}
