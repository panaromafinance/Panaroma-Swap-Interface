...
const PanaromaToken = styled.img`
      ...
      {showClaimPopup && !showClaimModal && (
        <StyledClaimPopup gap="md">
          ...
          <AutoColumn
            ...
            justify="center">
            <PanaromaToken width="48px" src={tokenLogo} />{" "}
            <ThemedText.DeprecatedWhite
              style={{ marginTop: "1rem" }}
              fontSize={36}
              fontWeight={600}>
              {unclaimedAmount?.toFixed(0, { groupSeparator: "," } ?? "-")} PANA
            </ThemedText.DeprecatedWhite>
            <ThemedText.DeprecatedWhite
            ...
            <ThemedText.DeprecatedSubHeader
              ...
              color="white">
              <Trans>
                Thanks for being part of the Panaromaswap community{" "}
                <Heart size={12} />
              </Trans>
            </ThemedText.DeprecatedSubHeader>
          </AutoColumn>
          <AutoColumn style={{ zIndex: 10 }} justify="center">
            <ButtonPrimary
              ...
              <Trans>Claim your PANA tokens</Trans>
            </ButtonPrimary>
          </AutoColumn>
        </StyledClaimPopup>
      )}
