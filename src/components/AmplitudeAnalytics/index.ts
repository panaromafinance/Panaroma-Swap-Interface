 ...
 *
 * Panaromaswap has two Amplitude projects: test and production. You must be a
...
export function initializeAnalytics(
  ...
  if (typeof API_KEY === "undefined") {
    throw new Error(
      `REACT_APP_AMPLITUDE_KEY must be a defined environment variable`
    );
  }
...
class UserModel {
  constructor(
    private isDevEnvironment = process.env.NODE_ENV === "development"
  ) {}
