        ...
        <ContentWrapper gap="lg">
          ...
          {stakingInfo?.earnedAmount && (
            <AutoColumn justify="center" gap="md">
              ...
              <ThemedText.DeprecatedBody>
                <Trans>Unclaimed PANA</Trans>
              </ThemedText.DeprecatedBody>
            </AutoColumn>
          )}
          <ThemedText.DeprecatedSubHeader style={{ textAlign: "center" }}>
            <Trans>
              When you withdraw, your PANA is claimed and your liquidity is
      ...
      {attempting && !hash && (
        <LoadingView onDismiss={wrappedOnDismiss}>
          <AutoColumn gap="12px" justify={"center"}>
            ...
            <ThemedText.DeprecatedBody fontSize={20}>
              <Trans>
                Claiming {stakingInfo?.earnedAmount?.toSignificant(4)} PANA
              </Trans>
            </ThemedText.DeprecatedBody>
          </AutoColumn>
        </LoadingView>
      ...
      {hash && (
        <SubmittedView onDismiss={wrappedOnDismiss} hash={hash}>
          <AutoColumn gap="12px" justify={"center"}>
            ...
            <ThemedText.DeprecatedBody fontSize={20}>
              <Trans>Withdrew PANA-V1!</Trans>
            </ThemedText.DeprecatedBody>
            <ThemedText.DeprecatedBody fontSize={20}>
              <Trans>Claimed PANA!</Trans>
            </ThemedText.DeprecatedBody>
          </AutoColumn>
        </SubmittedView>
      )}
