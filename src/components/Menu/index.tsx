          ...
          (() => {
            switch (menu) {
              ...
              default:
                return (
                  <MenuFlyout>
                    <MenuItem href="https://panaroma.finance/about-us/">
                      <div>
                        <Trans>About</Trans>
                      </div>
                      <Info opacity={0.6} size={16} />
                    </MenuItem>
                    {/* <MenuItem href="https://help.panaromaswap.org/">
                      <div>
                        <Trans>Help Center</Trans>
                      </div>
                      <HelpCircle opacity={0.6} size={16} />
                    </MenuItem> */}
                    {/* <MenuItem href="https://panaromaswap.canny.io/feature-requests">
                      <div>
                    ...
                    {/* <MenuItem href="https://discord.gg/FCfyBSbCU5">
                      ...
                      <ArrowUpRight opacity={0.6} size={12}/>
                    </MenuItem> */}
                    ...
                    <MenuItem href="https://doc.panaroma.finance/panaroma-finance-ecosystem/swap-exchange">
                      <div>
                        <Trans>Docs</Trans>
                      </div>
