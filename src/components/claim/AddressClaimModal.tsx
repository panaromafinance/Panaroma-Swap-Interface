        ...
        <ContentWrapper gap="lg">
          ...
          <AutoColumn
            ...
            <ThemedText.DeprecatedSubHeader fontWeight={500}>
              <Trans>
                Enter an address to trigger a PANA claim. If the address has any
                claimable PANA it will be sent to them on submission.
              </Trans>
            ...
            {claimConfirmed && (
              <>
                <ThemedText.DeprecatedSubHeader fontWeight={500} color="black">
                  ...
                  <Trans>Welcome to team Panaromacorn :) </Trans>
                  <span role="img" aria-label="party-hat">
                    🎉
                  </span>
                </ThemedText.DeprecatedSubHeader>
