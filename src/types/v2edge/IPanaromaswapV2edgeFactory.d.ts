...
interface IPanaromaswapV2edgeFactoryInterface extends ethers.utils.Interface {
  functions: {
...
export class IPanaromaswapV2edgeFactory extends BaseContract {
  ...
  interface: IPanaromaswapV2edgeFactoryInterface;
