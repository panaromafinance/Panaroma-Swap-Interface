...
interface IPanaromaswapV2edgePoolStateInterface extends ethers.utils.Interface {
  functions: {
...
export class IPanaromaswapV2edgePoolState extends BaseContract {
  ...
  interface: IPanaromaswapV2edgePoolStateInterface;
