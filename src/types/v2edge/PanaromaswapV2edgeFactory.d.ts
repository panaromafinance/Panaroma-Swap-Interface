...
interface PanaromaswapV2edgeFactoryInterface extends ethers.utils.Interface {
  functions: {
...
export class PanaromaswapV2edgeFactory extends BaseContract {
  ...
  interface: PanaromaswapV2edgeFactoryInterface;
