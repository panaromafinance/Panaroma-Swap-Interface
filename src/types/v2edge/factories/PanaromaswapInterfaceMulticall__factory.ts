...
import type {
  ...
  PanaromaswapInterfaceMulticallInterface,
} from "../PanaromaswapInterfaceMulticall";
  ...
  },
  {
    inputs: [
      {
        ...
        internalType: "struct PanaromaswapInterfaceMulticall.Call[]",
        name: "calls",
        type: "tuple[]",
      },
    ],
    ...
    outputs: [
      ...
      },
      {
        ...
        internalType: "struct PanaromaswapInterfaceMulticall.Result[]",
        name: "returnData",
        type: "tuple[]",
      },
    ],
...
export class PanaromaswapInterfaceMulticall__factory extends ContractFactory {
  constructor(
  ...
  ): Promise<PanaromaswapInterfaceMulticall> {
    return super.deploy(
      overrides || {}
    ) as Promise<PanaromaswapInterfaceMulticall>;
  }
  ...
  attach(address: string): PanaromaswapInterfaceMulticall {
    return super.attach(address) as PanaromaswapInterfaceMulticall;
  }
  connect(signer: Signer): PanaromaswapInterfaceMulticall__factory {
    return super.connect(signer) as PanaromaswapInterfaceMulticall__factory;
  }
  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): PanaromaswapInterfaceMulticallInterface {
    return new utils.Interface(_abi) as PanaromaswapInterfaceMulticallInterface;
  }
  static connect(
    address: string,
