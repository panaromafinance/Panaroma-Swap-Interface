...
interface PanaromaswapV2edgePoolInterface extends ethers.utils.Interface {
  functions: {
...
export class PanaromaswapV2edgePool extends BaseContract {
  ...
  interface: PanaromaswapV2edgePoolInterface;
