...
interface IPanaromaswapV2edgePoolInterface extends ethers.utils.Interface {
  functions: {
...
export class IPanaromaswapV2edgePool extends BaseContract {
  ...
  interface: IPanaromaswapV2edgePoolInterface;
