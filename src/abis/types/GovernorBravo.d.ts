...
interface GovernorBravoInterface extends ethers.utils.Interface {
  ...
  encodeFunctionData(functionFragment: "pana", values?: undefined): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "pana", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "votingDelay",
    data: BytesLike
  ): Result;
...
export class GovernorBravo extends BaseContract {
  ...
  functions: {
    ...
    pana(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    pana(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    pana(overrides?: CallOverrides): Promise<PopulatedTransaction>;
