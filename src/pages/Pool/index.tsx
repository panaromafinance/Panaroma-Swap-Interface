...
import { useV2edgePositions } from "hooks/useV2edgePositions";
...
export default function Pool() {
  ...
  const { positions, loading: positionsLoading } = useV2edgePositions(account);
  ...
  const showV1Features = Boolean(V1_FACTORY_ADDRESSES[chainId]);
  ...
  const menuItems = [
    ...
    },
    {
      ...
      link: "https://docs.panaromaswap.org/",
      external: true
    }
  ];
                ...
                {positionsLoading ? (
                  ...
                  <ErrorContainer>
                    <ThemedText.DeprecatedBody
                      ...
                      <div>
                        <Trans>
                          Your active V2edge liquidity positions will appear here.
                        </Trans>
                      </div>
                    </ThemedText.DeprecatedBody>
