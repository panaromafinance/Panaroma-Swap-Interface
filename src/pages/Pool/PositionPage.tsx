...
import { NonfungiblePositionManager, Pool, Position } from "@panaromafinance/panaromaswap_v2edgesdk";
...
export function PositionPage() {
  ...
  const { loading, position: positionDetails } =
    useV2edgePositionFromTokenId(parsedTokenId);
