...
import { PairState, useV1Pair } from "../../hooks/useV1Pairs";
...
export default function PoolFinder() {
  ...
  const [pairState, pair] = useV1Pair(
    currency0 ?? undefined,
    currency1 ?? undefined
  );
    ...
    <LightCard padding="45px 10px">
      <Text textAlign="center">
        {!account ? (
          ...
          <Trans>Select a token to find your v1 liquidity.</Trans>
        )}
      </Text>
    </LightCard>
  );
  ...
  return (
    <Trace page={PageName.POOL_PAGE} shouldLogImpression>
      <>
        <AppBody>
          <FindPoolTabs origin={query.get("origin") ?? "/pool/v1"} />
            ...
            <BlueCard>
              <AutoColumn gap="10px">
                <ThemedText.DeprecatedLink
                  ...
                  <Trans>
                    <b>Tip:</b> Use this tool to find v1 pools that don&apos;t
