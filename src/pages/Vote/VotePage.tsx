...
import { CurrencyAmount, Fraction, Token } from "@panaromafinance/panaromaswap_sdkcore";
...
const Progress = styled.div<{
  ...
  background-color: ${({ theme, status }) =>
    status === "for" ? theme.deprecated_green1 : theme.deprecated_red1};
...
export default function VotePage() {
  ...
  const eta = proposalData?.eta
    ? new Date(proposalData.eta.mul(ms`1 second`).toNumber())
    : undefined;
                ...
                !showVotingButtons && (
                  <GreyCard>
                    <ThemedText.DeprecatedBlack>
                      <Trans>
                        Only PANA votes that were self delegated or delegated to
