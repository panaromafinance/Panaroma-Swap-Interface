...
export default function Landing() {
  ...
  const uniBalance: CurrencyAmount<Token> | undefined = useTokenBalance(
    account ?? undefined,
    chainId ? PANA[chainId] : undefined
  );
      ...
      <Trace page={PageName.VOTE_PAGE} shouldLogImpression>
        <PageWrapper gap="lg" justify="center">
                ...
                <AutoColumn gap="md">
                  <RowBetween>
                    <ThemedText.DeprecatedWhite fontWeight={600}>
                      <Trans>Panaromaswap Governance</Trans>
                    </ThemedText.DeprecatedWhite>
                  </RowBetween>
                  <RowBetween>
                    <ThemedText.DeprecatedWhite fontSize={14}>
                      <Trans>
                      PANA tokens represent voting shares in Panaromaswap
                        governance. You can vote on each proposal yourselfor
                  ...
                  <ExternalLink
                    ...
                    href="https://panaromaswap.org/blog/PANA"
                    target="_blank">
                    <ThemedText.DeprecatedWhite fontSize={14}>
                      <Trans>Read more about Panaromaswap governance</Trans>
                    </ThemedText.DeprecatedWhite>
                  </ExternalLink>
                </AutoColumn>
              </CardSection>
          ...
          <ThemedText.DeprecatedSubHeader color="text3">
            <Trans>
              A minimum threshold of 0.25% of the total PANA supply is required
              to submit proposals
            </Trans>
