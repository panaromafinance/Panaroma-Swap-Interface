...
import { FeeAmount, NonfungiblePositionManager } from "@panaromafinance/panaromaswap_v2edgesdk";
...
import {
  ...
  useV2edgeDerivedMintInfo,
  useV2edgeMintActionHandlers,
  useV2edgeMintState
} from "state/mint/v2edge/hooks";
...
import { Bound, Field } from "../../state/mint/v2edge/actions";
...
export default function AddLiquidity() {
  ...
  const { position: existingPositionDetails, loading: positionLoading } =
    useV2edgePositionFromTokenId(tokenId ? BigNumber.from(tokenId) : undefined);
  ...
  const {
    ...
    onRightRangeInput,
    onStartPriceInput
  } = useV2edgeMintActionHandlers(noLiquidity);
  ...
  // console.log(usdcValues, maxAmounts, atMaxAmounts)
 ...
 // console.log([approvalA, approveACallback]);
 // console.log([approvalB, approveBCallback]);
                          ...
                          {noLiquidity && (
                            <BlueCard
                              ...
                              <ThemedText.DeprecatedBody
                                ...
                                <Trans>
                                  This pool must be initialized before you can
                                  add liquidity. To initialize, select a
                                  starting price for the pool. Then, enter your
                                  liquidity price range and deposit amount. Gas
                                  fees will be higher than usual due to the
                                  ...
                                  <ThemedText.DeprecatedYellow
                                    ...
                                    <Trans>
                                      ...
                                      <ExternalLink
                                        ...
                                        href={
                                          "https://help.panaromaswap.org/en/articles/5434296-can-i-provide-liquidity-over-the-full-range-in-v2edge"
                                        }>
                                        here
                                      </ExternalLink>
                                      .
