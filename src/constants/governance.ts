...
> = {
  [SupportedChainId.MAINNET]: {
    [PANA_ADDRESS[SupportedChainId.MAINNET]]: "PANA",
    [TIMELOCK_ADDRESS[SupportedChainId.MAINNET]]: "Timelock",
    [GOVERNANCE_ALPHA_V0_ADDRESSES[SupportedChainId.MAINNET]]:
      "Governance (V0)",
    [GOVERNANCE_ALPHA_V1_ADDRESSES[SupportedChainId.MAINNET]]:
      "Governance (V1)",
