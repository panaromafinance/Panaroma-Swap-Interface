...
import { DAI, PANA, USDC_MAINNET } from "../constants/tokens";
...
const PERMITTABLE_TOKENS: {
  ...
  1: {
    ...
    [PANA[1].address]: { type: PermitType.AMOUNT, name: "Panaromaswap" }
  },
  4: {
    ...
    [PANA[4].address]: { type: PermitType.AMOUNT, name: "Panaromaswap" }
  },
  3: {
    [PANA[3].address]: { type: PermitType.AMOUNT, name: "Panaromaswap" },
  ...
  5: {
    [PANA[5].address]: { type: PermitType.AMOUNT, name: "Panaromaswap" }
  },
  42: {
    [PANA[42].address]: { type: PermitType.AMOUNT, name: "Panaromaswap" }
  }
};
